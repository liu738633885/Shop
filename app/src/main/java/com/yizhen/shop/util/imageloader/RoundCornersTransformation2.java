...
import static com.yizhen.shop.util.imageloader.RoundCornersTransformation2.CornerType.ALL;
...
public class RoundCornersTransformation2 implements Transformation<Bitmap> {
    ...
    public RoundCornersTransformation2(Context context, int radius, CornerType type) {
