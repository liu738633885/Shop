...
public class GoodsListFragment extends BaseFragment implements LewisSwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    public static GoodsListFragment newInstance(String url) {
    ...
    private void get_goods_list(int num) {
